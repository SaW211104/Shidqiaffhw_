...
map.getView().fit([11863116.571520, -713062.271133, 11924715.099081, -674538.538848], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Sekolah berisiko banjir di DKI Jakarta By Ipeh</h2>';
        return titleElement;
    })(),
